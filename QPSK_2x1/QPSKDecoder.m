classdef QPSKDecoder < matlab.System
...
% Copyright 2012-2016 The MathWorks, Inc.
    ...
    properties (Constant, Access = private)
        ...
        pModulatedHeader = sqrt(2)/2 * (-1-1i) * QPSKDecoder.pBarkerCode;
    end
    
    methods
        function obj = QPSKDecoder(varargin)
    ...
    methods (Access = protected)
        function setupImpl(obj, ~)            
            ...
            obj.pBitGenerator = QPSKBitsGen('MessageLength', obj.MessageLength, ...
